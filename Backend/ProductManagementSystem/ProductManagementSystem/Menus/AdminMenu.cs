    ...
    public class AdminMenu
    {
        public static void Display()
        {
            ...
            while (isRunning)
            {
                Console.Clear();
                Console.WriteLine("\n===== ADMIN MENU =====");
                Console.WriteLine("1. EmployeeManagement");
                Console.WriteLine("2. DepartmentManagement");
                Console.WriteLine("3. RoleManagement");
                Console.WriteLine("4. CategoryManagement");
                Console.WriteLine("5. ProductManagement");
                Console.WriteLine("6. CustomerManagement");
                Console.WriteLine("7. OrdersManagement");
        ...
        private static void EmployeeManagement()
        {
            ...
            switch (choice)
            {
                ...
                case "2":
                    ...
                    newEmployee.RoleId = Convert.ToInt32(Console.ReadLine());
                ...
                case "3":
                    ...
                    updateEmployee.EmployeeId = Convert.ToInt32(Console.ReadLine());

                    Console.Write("Employee Name : ");
                    updateEmployee.EmployeeName = Console.ReadLine();

                    Console.Write("Department Id : ");
                    updateEmployee.DepartmentId = Convert.ToInt32(Console.ReadLine());

                    Console.Write("Role Id : ");
                    updateEmployee.RoleId = Convert.ToInt32(Console.ReadLine());

                    Console.Write("Email : ");
                    updateEmployee.Email = Console.ReadLine();

                    Console.Write("Phone : ");
                    updateEmployee.Phone = Console.ReadLine();
                ...
                case "5":
                    ...
                    List<Employee> searchEmployees = employeeService.SearchEmployee(employeeName);
        ...
        private static void DepartmentManagement()
        {
            ...
            switch (choice)
            {
                case "1":
                    ...
                    List<Department> departments = departmentService.DisplayDepartments();
                ...
                case "3":
                    ...
                    Console.Write("Department Id : ");
                    updateDepartment.DepartmentId = Convert.ToInt32(Console.ReadLine());

                    Console.Write("Department Name : ");
                    updateDepartment.DepartmentName = Console.ReadLine();
                ...
                case "5":
                    ...
                    List<Department> searchDepartments = departmentService.SearchDepartment(departmentName);

                    foreach (Department department in searchDepartments)
                    {
                        Console.WriteLine("----------------------------------");
                        Console.WriteLine($"Department Id   : {department.DepartmentId}");
                        Console.WriteLine($"Department Name : {department.DepartmentName}");
        ...
        private static void RoleManagement()
        {
            ...
            switch (choice)
            {
                case "1":
                    ...
                    List<Role> roles = roleService.DisplayRoles();
                ...
                case "3":
                    ...
                    Console.Write("Role Id : ");
                    updateRole.RoleId = Convert.ToInt32(Console.ReadLine());

                    Console.Write("Role Name : ");
                    updateRole.RoleName = Console.ReadLine();
                ...
                case "5":
                    ...
                    List<Role> searchRoles = roleService.SearchRole(roleName);

                    foreach (Role role in searchRoles)
                    {
                        Console.WriteLine("--------------------------------");
                        Console.WriteLine($"Role Id   : {role.RoleId}");
                        Console.WriteLine($"Role Name : {role.RoleName}");
